...
/* TWI instance. */
static const nrf_drv_twi_t m_twi = NRF_DRV_TWI_INSTANCE(OLED_TWI_INSTANCE);
...
,
...
0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x00,0x00,0x00,0x03,0x03,0x07,0x07,0x07,0x03,
0x03,0x00,0x07,0x07,0x07,0x00,0x00,0x00,0x00,0x07,0x07,0x07,0x00,0x00,0x00,0x00,
0x00,0xC1,0xC3,0xC3,0xC7,0xC7,0xC7,0xC3,0xE1,0xF0,0x7F,0x3F,0x1F,0x00,0x00,0x00,
0x00,0x07,0x07,0x07,0x00,0x00,0x00,0x00,0x00,0x01,0x03,0x03,0x03,0x07,0x07,0x07,
...
void oled_init_i2c(void)
{
    ...
    NRF_LOG_FLUSH();
	  ...
	  tx_on_data[0] = 0x81;
	  OLED_I2C_register_write(tx_on_data, 1);
	  tx_on_data[0] = 0xBF; // contract control
	  OLED_I2C_register_write(tx_on_data, 1);
	  tx_on_data[0] = 0xA1;
	  OLED_I2C_register_write(tx_on_data, 1);
	  tx_on_data[0] = 0xA6;
	  ...
	  tx_on_data[0] = 0x3F;
	  OLED_I2C_register_write(tx_on_data, 1);
	  tx_on_data[0] = 0xad; // set charge pump enable
	  OLED_I2C_register_write(tx_on_data, 1);
	  tx_on_data[0] = 0x8a;
	  OLED_I2C_register_write(tx_on_data, 1);
	  tx_on_data[0] = 0x32;
