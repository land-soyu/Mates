 ...
 */
public class CheckFarmSensorDataHTTPTask extends AsyncTask<String, Void, String> {
    private Context mContext;
    private Handler mHandler;
    private final String TAG = getClass().getName();

    public CheckFarmSensorDataHTTPTask(Context context, Handler handler) {
        mContext = context;
        mHandler = handler;
    }
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            ...
            String urlString = Config.SERVER_URL + Config.CHECK_FARM_SENSOR_DATA;
