 ...
 */
public class GetFarmSensorListDataHTTPTask extends AsyncTask<String, Void, String> {
    private Context mContext;
    private Handler mHandler;
    private final String TAG = getClass().getName();

    public GetFarmSensorListDataHTTPTask(Context context, Handler handler) {
        mContext = context;
        mHandler = handler;
    }
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            ...
            String urlString = Config.SERVER_URL + Config.GET_FARM_SENSOR_LIST_DATA;
    ...
    protected void onPostExecute(String result) {
        ...
        if (mHandler != null) {
            ...
            msg.what = Config.MESSAGE_GET_FARM_SENSOR_LIST_DATA;
            msg.obj = result;
