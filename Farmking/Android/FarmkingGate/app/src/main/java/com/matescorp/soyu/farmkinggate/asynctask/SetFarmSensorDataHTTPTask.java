 ...
 */
public class SetFarmSensorDataHTTPTask extends AsyncTask<String, Void, String> {
    private Context mContext;
    private Handler mHandler;
    private final String TAG = getClass().getName();

    public SetFarmSensorDataHTTPTask(Context context, Handler handler) {
        mContext = context;
        mHandler = handler;
    }
    ...
    protected String doInBackground(String... args) {
        ...
        try {
            String urlString = Config.SERVER_URL + Config.SET_FARM_SENSOR_DATA;
    ...
    protected void onPostExecute(String result) {
        ...
        if (mHandler != null) {
            ...
            msg.what = Config.MESSAGE_SET_FARM_SENSOR_DATA;
            msg.obj = result;
