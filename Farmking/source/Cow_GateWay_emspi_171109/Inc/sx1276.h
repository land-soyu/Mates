...
#define MAX_RXBUF 255

typedef struct
{
	void(*Init)();
	void(*StartTx)(uint8_t *TxBuf,uint8_t TxBufSize);
	void(*StartRx)();
	void(*Process)();
	void(*Reset)();
...
_SX1276_E_ SX1276_s *SX1276;
_SX1276_E_ SX1276Reg_Lora *SX1276RegLora;
_SX1276_E_ void SX1276Init(void);
_SX1276_E_ void SX1276_Pin_PowerOff(void);
_SX1276_E_ void SX1276StartTx(uint8_t *TxBuf,uint8_t TxBufSize);
_SX1276_E_ void SX1276StartRx(void);
_SX1276_E_ void SX1276Process(void);
_SX1276_E_ void SX1276Reset(void);
_SX1276_E_ void SX1276SetOpMode(uint8_t OpMode);
_SX1276_E_ void SX1276Write( uint8_t addr, uint8_t data );
_SX1276_E_ uint8_t SX1276Read( uint8_t addr );
_SX1276_E_ void SX1276WriteBuffer( uint8_t addr, uint8_t *buffer, uint8_t size );
_SX1276_E_ void SX1276ReadBuffer( uint8_t addr, uint8_t *buffer, uint8_t size );
_SX1276_E_ void SX1276WriteFifo( uint8_t *buffer, uint8_t size );
_SX1276_E_ void SX1276ReadFifo( uint8_t *buffer, uint8_t size );
//_SX1276_E_ void SX1276SpiOut( uint8_t data );
//_SX1276_E_ void SX1276SpiIn( uint8_t *data );
_SX1276_E_ void SX1276SetFreq( uint32_t freq );
_SX1276_E_ uint32_t SX1276GetFreq(void);
_SX1276_E_ void SX1276SetTxPower( int8_t power );
_SX1276_E_ void SX1276SetBandWidth(uint16_t bandWidth);
_SX1276_E_ void SX1276SetCodingRate(uint8_t codingRate);
_SX1276_E_ void SX1276SetSpreadingFactor(uint8_t SF);
_SX1276_E_ void SX1276SetCrc(uint8_t crcFlag);
_SX1276_E_ void SX1276SetHeader(uint8_t HeaderMode);
_SX1276_E_ void SX1276GetPacketRssi(int16_t *data);
_SX1276_E_ void SX1276SetSymbTimeout( uint16_t value );
_SX1276_E_ void SX1276SetPayloadLength( uint8_t value );
_SX1276_E_ void SX1276SetPayloadMaxLength( uint8_t value );
_SX1276_E_ void SX1276SetLowDatarateOptimize(uint8_t enable );
