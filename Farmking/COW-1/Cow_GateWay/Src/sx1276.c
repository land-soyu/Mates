...
void SX1276SetOpMode(uint8_t OpMode)
{
	...
	{
	//	printf("TX Running..\r\n");
		HAL_GPIO_WritePin(RF_SWITH_ON_OFF_GPIO_Port, RF_SWITH_ON_OFF_Pin, GPIO_PIN_RESET); // tx mode
	...
	{
	//	printf("RX Running..\r\n");
		HAL_GPIO_WritePin(RF_SWITH_ON_OFF_GPIO_Port, RF_SWITH_ON_OFF_Pin, GPIO_PIN_SET); // rx mode 
