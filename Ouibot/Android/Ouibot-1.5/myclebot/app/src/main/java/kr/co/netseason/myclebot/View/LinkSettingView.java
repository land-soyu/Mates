...
import kr.co.netseason.myclebot.Security.SecureModeSettingActivity;
...
public class LinkSettingView extends Fragment implements View.OnClickListener {
    ...
    public static void LoadDBData() {
        Logger.d("LinkSettingView", "LoadDBData call mSlaveListViewAdapter == " + mSlaveListViewAdapter);
        ...
        for (int i = 0; i < slaveDataList.size(); i++) {
            ...
            MainActivity.CONTEXT.getSecureConfig(slaveDataList.get(i).getSlaveRtcid());
        }
        mSlaveListViewAdapter.dataChange();
        mMasterListViewAdapter.dataChange();
    }

    private synchronized static ArrayList<UibotListData> getMasterList(String id) {
    ...
    private synchronized static ArrayList<UibotListData> getSlaveList(String masterId) {
        ContentResolver resolver = MainActivity.CONTEXT.getContentResolver();
        Cursor c = resolver.query(SecureProvider.USER_INFO_TABLE_URI, new String[]{SecureSQLiteHelper.COL_SLAVE_ID,SecureSQLiteHelper.COL_SECURE_ON_OFF_VALUE},
        ...
        if (c != null && c.moveToFirst()) {
            try {
                do {
                    ...
                    String secureOnOffValue = c.getString(c.getColumnIndex(SecureSQLiteHelper.COL_SECURE_ON_OFF_VALUE));
                    slaveData.add(new UibotListData(null, slave, Config.DETECT_MODE_DEFAULT, secureOnOffValue, Config.VIDEO_SAVE_MODE_DEAFULT, Config.VIDEO_SAVE_TIME_DEFAULT, Config.SENSITIVITY_DEFAULT, Config.DO_AFTER_SETTING_TIME_DEFAULT
                            , Config.VIDEO_SAVE_MODE_DEAFULT, Config.NONE_ACTIVITY_VIDEO_SAVE_TIME_DEFAULT, Config.NONE_ACTIVITY_DETECTION_SENSITIVITY_DEFAULT, Config.NONE_ACTIVITY_SETTING_TIME_DEFAULT));
                } while (c.moveToNext());
            }catch (Exception e){
                e.printStackTrace();
...
//                holder.mSwitch.setOnCheckedChangeListener(videoSaveCheck);
            ...
            UibotListData mData = mUibotListData.get(position);
            ...
            Logger.d("getView", "mData.getDetectOnOff() = " + mData.getDetectOnOff());
        ...
        View.OnClickListener mSwitchClicked = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!getSecureOnOffValue(data.getDetectOnOff())) {
                    MainActivity.CONTEXT.startSecureMode(((UibotListData) v.getTag()).getSlaveRtcid());
                } else {
                    MainActivity.CONTEXT.stopSecureMode(((UibotListData) v.getTag()).getSlaveRtcid());
                }
            }
        };
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_mode_setting: {
                        Intent intent = new Intent(mContext, SecureModeSettingActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
