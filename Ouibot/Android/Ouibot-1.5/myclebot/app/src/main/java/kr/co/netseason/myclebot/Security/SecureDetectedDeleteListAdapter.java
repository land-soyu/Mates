 ...
 */
public class SecureDetectedDeleteListAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<SecureDetectedData> data = new ArrayList<SecureDetectedData>();

    public SecureDetectedDeleteListAdapter(Context context, ArrayList<SecureDetectedData> data) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = inflater.inflate(R.layout.detected_item_delete_view, null);
