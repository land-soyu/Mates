 ...
 */
public class DataSessionMessageReceiveAsyncTask extends AsyncTask<Void, Void, Boolean> {
    ...
    public DataSessionMessageReceiveAsyncTask(Context context, Messenger service, JSONObject json, int threadTime) {
        mService = service;
        this.json = json;
